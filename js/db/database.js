/**
 * Objeto y constructor para generar nuevas preguntas
 */
export class Question {
  /**
   * Constructor del objeto Question
   * @param {*} level nivel de dificultad en tipo  Number
   * @param {*} category categoria a la que pertenece en tipo string
   * @param {*} question pregunta en tipo string
   * @param {*} answer  respuesta correcta
   * @param {*} falseA  respuesta falsa
   * @param {*} falseB  respuesta falsa
   * @param {*} falseC  respuesta falsa
   * @param {*} prize  premio por acertar la misma
   * @param {*} image  imagen de la pregunta, ubicacion de la misma en tipo string
   */
  constructor(
    level,
    category,
...
/**
 * Funcion para setear las preguntas en la meoria local del navegador
 */
...
/**
 * Clase para crear un objeto de tipo jugador
 */
class Player {
  /**
 ...
 * @param {*} name nombre del jugador
 * @returns devuelve un nuevo jugador en tipo objeto
 */
export const playerInstance = (name) => {
  return new Player(name);
};
/**
 * Seteo de base de jugadores en la memoria del navegador
 */
